...
fun LoginScreen(
    ...
    val meshGradientPainter = remember(primaryColor, backgroundColor, tertiaryColor) {
        MeshGradientPainter(1, 1) {
            setVertex(0, 0, Offset(0f, 0f), primaryColor.copy(alpha = 0.25f))
            setVertex(0, 1, Offset(1f, 0f), backgroundColor)
            setVertex(1, 0, Offset(0f, 1f), tertiaryColor.copy(alpha = 0.2f))
            setVertex(1, 1, Offset(1f, 1f), backgroundColor)
        }
    }
